...
function ColorPickerByIndex(min, max) {
         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                overviewPlusDetailPaneBackgroundImageUri: "https://jp.igniteui.com/images/samples/maps/world.png",
                series: [{
                    type: "geographicShape",
                    name: "worldCountries",
                    markerType: "none",
                    shapeMemberPath: "points",
                    shapeDataSource: 'https://jp.igniteui.com/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'https://jp.igniteui.com/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
