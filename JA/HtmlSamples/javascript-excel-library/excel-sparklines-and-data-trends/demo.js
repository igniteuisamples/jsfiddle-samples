$(function() {
                ...
                columnLayouts: [
                    {
                        ...
                        width: "100%",
                        columns: [
                            { key: "OrderID", headerText: "$$(Northwind_Orders_OrderID)", dataType: "number", width: "10%", hidden: true },
                            { key: "Freight", headerText: "$$(Northwind_Orders_Freight)", dataType: "string", width: "15%" },
            ...
            $("#exportButton").igButton({ labelText: "Excel へエクスポート (.xlsx)" });
