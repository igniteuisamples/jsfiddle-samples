         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                series: [{
                    ...
                    shapeDataSource: 'https://igniteui.com/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'https://igniteui.com/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
